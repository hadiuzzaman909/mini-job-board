...
const LocationSchema = new Schema<IJob['location']>({
...
const JobSchema = new Schema<IJob>({
  ...
  requirements:        { type: [String], required: true, validate: [(arr: string[]) => arr.length > 0, 'At least one requirement is required'] },
